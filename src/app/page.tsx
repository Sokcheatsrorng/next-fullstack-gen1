    ...
    <div>
      ...
      {subscription ? (
        <>
          ...
          <button className='bg-red-500 p-4 rounded' onClick={unsubscribeFromPush}>Unsubscribe</button>
          <input
            type="text"
          ...
          />
          <button  className='bg-red-500 p-4 rounded' onClick={sendTestNotification}>Send Test</button>
        </>
      ) : (
        <>
